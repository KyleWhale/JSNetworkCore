...
@property (nonatomic, assign, readwrite) JSResponseStatus status;
...
- (JSResponseStatus)responseStatusWithError:(NSError *)error
{
    if (error) {
        JSResponseStatus result = CTURLResponseStatusErrorNoNetwork;
        // 除了超时以外，所有错误都当成是无网络
